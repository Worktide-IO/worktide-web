...
export type WorkspaceInvitationHtmlRoleEnum = "owner" | "admin" | "member" | "guest";

export type WorkspaceInvitationHtmlStatusEnum = "pending" | "accepted" | "expired" | "revoked";
...
*/
export type WorkspaceInvitationHtml = {
    /**
     * @type string, email
    */
    email: string;
    ...
    */
    role?: WorkspaceInvitationHtmlRoleEnum;
    /**
     * @default "pending"
     * @type string | undefined
    */
    status?: WorkspaceInvitationHtmlStatusEnum;
    /**
