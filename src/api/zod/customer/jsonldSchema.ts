 ...
 */
export const customerJsonldSchema = z.lazy(() => hydraItemBaseSchemaSchema).and(z.object({
    "name": z.string().describe("Display name — usually the company name; for individuals, \"Lastname, Firstname\"."),
