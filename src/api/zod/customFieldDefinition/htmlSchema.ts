...
import { customFieldOptionHtmlSchema } from "../customFieldOption/htmlSchema.ts";
 ...
 */
export const customFieldDefinitionHtmlSchema = z.object({
...
get "optionDefinitions"(){
                return z.array(customFieldOptionHtmlSchema).optional()
              },
"id": z.uuid().nullish(),
