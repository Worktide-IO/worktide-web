...
import { customFieldOptionSchema } from "../customFieldOptionSchema.ts";
 ...
 */
export const customFieldDefinitionJsonMergePatchSchema = z.object({
...
get "optionDefinitions"(){
                return z.array(customFieldOptionSchema).optional()
              },
"id": z.uuid().nullish(),
