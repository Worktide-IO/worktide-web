 ...
 */
export const documentJsonldSchema = z.lazy(() => hydraItemBaseSchemaSchema).and(z.object({
...
"revisions": z.optional(z.array(z.string())),
"workflowState": z.optional(z.enum(["draft", "review", "published"]).default("draft")),
"reviewers": z.optional(z.array(z.string()).describe("Users assigned to review the document while it sits in the `review`\nstate. Assignment is independent of contributors (reviewers may\nread-only) — when the state is `draft` or `published`, this list\nis informational only.")),
